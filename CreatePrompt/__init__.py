...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if len(empty_db) == 0:
        ...
        id = list(prompts_container.query_items(query="SELECT VALUE MAX(StringToNumber(c.id)) from c", enable_cross_partition_query=True))
    ...
    try:
        ...
        if len(user_exists) == 0 :
            ...
            if len(text) < 20 or len(text) > 100:
                ...
                prompts_container.create_item(body=result)
